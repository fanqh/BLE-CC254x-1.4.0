...
//
//
//int between(unsigned char a,unsigned char b,unsigned char c)	//ÅÐ¶ÏbÊÇ·ñÔÚ£¨a,c£©
//{
...
static int between(unsigned char a,unsigned char b,unsigned char c)	//ÅÐ¶ÏbÊÇ·ñÔÚ£¨a,c£©
{
	if(((a<=b)&&(b<=c))||((c<a)&&(a<=b))||((b<=c)&&(c<a)))
		return 1;
	else
